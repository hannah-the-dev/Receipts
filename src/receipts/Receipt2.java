...
//		int k21_itemQty3 = 1;
		...
		String k21_item1Str = k21_by.gettingSpaces(k21_item1, 10);						// 10번째 자리에서 자른 문자열1
		String k21_item2Str = k21_by.gettingSpaces(k21_item2, 10);						// 10번째 자리에서 자른 문자열2						
		String k21_item3Str = k21_by.gettingSpaces(k21_item3, 10);						// 10번째 자리에서 자른 문자열3
