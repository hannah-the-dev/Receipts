...
//		int k21_itemQty3 = 1;
		...
		String item1Str = by.gettingSpaces(k21_item1, 10);						// 14번째 자리에서 자른 문자열1
		String item2Str = by.gettingSpaces(k21_item2, 10);						// 14번째 자리에서 자른 문자열2						
		String item3Str = by.gettingSpaces(k21_item3, 10);						// 14번째 자리에서 자른 문자열3
		...
		int k21_beforeTax = (int) Math.floor(k21_amountSum/11.0*10.0);						// 과세금액 계산(소수점 올림)
